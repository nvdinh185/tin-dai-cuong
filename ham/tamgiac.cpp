...
int laTamGiac(int, int, int);
int tamGiacCan(int, int, int);
...
int main(){
	...
	if(laTamGiac(a, b, c)==1){
		...
		if(tamGiacDeu(a, b, c)==1) printf("Ba so vua nhap tao thanh tam giac deu!");

		else if(tamGiacCan(a, b, c)==1) printf("Ba so vua nhap tao thanh tam giac can!");

		else if(tamGiacVuong(a, b, c)==1) printf("Ba so vua nhap tao thanh tam giac vuong!");
